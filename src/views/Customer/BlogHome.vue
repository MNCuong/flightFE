    ...
    <div class="container">
      <div class="row d-flex align-items-center justify-content-center">
        <div class="about-content blog-header-content col-lg-12">
          ...
          <a class="primary-btn" href="/blog-single">
            View More
          </a>
        </div>
      </div>
              ...
              <a href="#" target="_blank">
                <div class="thumb">
                  <img alt=""
                       ...
                       src="@/assets/img/blog/cat-widget1.jpg"/>
                </div>
            ...
            <div class="content relative">
              ...
              <a href="#" target="_blank">
                <div class="thumb">
                  <img alt=""
                       class="content-image img-fluid d-block mx-auto"
                       src="@/assets/img/blog/cat-widget2.jpg"/>
                </div>
                <div class="content-details">
                  <h4
                      class="content-title mx-auto text-uppercase">
            ...
            <div class="content relative">
              ...
              <a href="#" target="_blank">
                <div class="thumb">
                  <img alt=""
                       class="content-image img-fluid d-block mx-auto"
                       src="@/assets/img/blog/cat-widget3.jpg"/>
                </div>
                <div class="content-details">
                  <h4
                      class="content-title mx-auto text-uppercase">
        ...
        <div class="col-lg-8 posts-list">
          <div class="single-post row">
            ...
            <div class="col-lg-9 col-md-9">
              ...
              <a class="posts-title" href="/blog-single">
                <h3>
          ...
          <div class="single-post row">
            ...
            <div class="col-lg-9 col-md-9">
              <div class="feature-img">
                <img alt="" class="img-fluid"
                     src="@/assets/img/blog/feature-img2.jpg"/>
              </div>
              <a class="posts-title" href="/blog-singlee">
                <h3>
          ...
          <div class="single-post row">
            ...
            <div class="col-lg-9 col-md-9">
              <div class="feature-img">
                <img alt="" class="img-fluid"
                     src="@/assets/img/blog/feature-img3.jpg"/>
              </div>
              <a class="posts-title" href="/blog-single">
                <h3>
          ...
          <div class="single-post row">
            ...
            <div class="col-lg-9 col-md-9">
              <div class="feature-img">
                <img alt="" class="img-fluid"
                     src="@/assets/img/blog/feature-img4.jpg"/>
              </div>
              <a class="posts-title" href="/blog-single">
                <h3>
                  The Night Sky
          ...
          <div class="single-post row">
            ...
            <div class="col-lg-9 col-md-9">
              <div class="feature-img">
                <img alt="" class="img-fluid"
                     src="@/assets/img/blog/feature-img5.jpg"/>
              </div>
              <a class="posts-title" href="/blog-single">
                <h3>
                  Telescopes 101
        ...
        <div class="col-lg-4 sidebar-widgets">
          <div class="widget-wrap">
            ...
            <div class="single-sidebar-widget ads-widget">
              <a href="#">
                <img alt="" class="img-fluid"
                     src="@/assets/img/blog/ads-banner.jpg"/>
              </a>
            </div>
