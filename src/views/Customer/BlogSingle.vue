          ...
          <div class="single-post row">
            <div class="col-lg-12">
              <div class="feature-img">
                <img alt="" class="img-fluid" src="@/assets/img/blog/feature-img1.jpg"/>
              </div>
            </div>
          ...
          <div class="comments-area">
            ...
            <div class="comment-list">
              <div class="single-comment justify-content-between d-flex">
                <div class="user justify-content-between d-flex">
                  <div class="thumb">
                    <img alt="" src="@/assets/img/blog/c1.jpg"/>
                  </div>
                  <div class="desc">
                    <h5>
                      <a href="#">
            ...
            <div class="comment-list left-padding">
              <div class="single-comment justify-content-between d-flex">
                <div class="user justify-content-between d-flex">
                  <div class="thumb">
                    <img alt="" src="@/assets/img/blog/c2.jpg"/>
                  </div>
                  <div class="desc">
                    <h5>
                      <a href="#">
            ...
            <div class="comment-list left-padding">
              <div class="single-comment justify-content-between d-flex">
                <div class="user justify-content-between d-flex">
                  <div class="thumb">
                    <img alt="" src="@/assets/img/blog/c3.jpg"/>
                  </div>
                  <div class="desc">
                    <h5>
                      <a href="#">
            ...
            <div class="comment-list">
              <div class="single-comment justify-content-between d-flex">
                <div class="user justify-content-between d-flex">
                  <div class="thumb">
                    <img alt="" src="@/assets/img/blog/c4.jpg"/>
                  </div>
                  <div class="desc">
                    <h5>
                      <a href="#">
            ...
            <div class="comment-list">
              <div class="single-comment justify-content-between d-flex">
                <div class="user justify-content-between d-flex">
                  <div class="thumb">
                    <img alt="" src="@/assets/img/blog/c5.jpg"/>
                  </div>
                  <div class="desc">
                    <h5>
                      <a href="#">
            ...
            <form>
              ...
              <div class="form-group">
                <input class="form-control" id="subject"
                       ...
                       onfocus="this.placeholder = ''" placeholder="Subject"
                       type="text"/>
              </div>
              <div class="form-group">
                                                        <textarea class="form-control mb-10" name="message"
                                                                  onblur="this.placeholder = 'Messege'"
                                                                  onfocus="this.placeholder = ''" placeholder="Messege"
          ...
          <div class="widget-wrap">
            <div class="single-sidebar-widget search-widget">
              <form action="#" class="search-form">
                <input name="search" onblur="this.placeholder = 'Search Posts'"
                       onfocus="this.placeholder = ''"
                       placeholder="Search Posts" type="text"/>
                <button type="submit">
            ...
            <div class="single-sidebar-widget user-info-widget">
              <img alt="" src="@/assets/img/blog/user-info.png"/>
              <a href="#">
                <h4>
                  Charlie Barber
                </h4>
            ...
            <div class="single-sidebar-widget popular-post-widget">
              ...
              <div class="popular-post-list">
                <div
                    class="single-post-list d-flex flex-row align-items-center">
                  <div class="thumb">
                    <img alt="" class="img-fluid"
                         src="@/assets/img/blog/pp1.jpg"/>
                  </div>
                  <div class="details">
                    <a href="/blog-single">
                      <h6>
            ...
            <div class="single-sidebar-widget ads-widget">
              <a href="#">
                <img alt="" class="img-fluid" src="@/assets/img/blog/ads-banner.jpg"/>
              </a>
            </div>
