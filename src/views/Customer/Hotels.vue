      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="single-destinations">
            <div class="thumb">
              <img alt="" src="@/assets/img/hotels/d1.jpg"/>
            </div>
            <div class="details">
        ...
        <div class="col-lg-4">
          <div class="single-destinations">
            <div class="thumb">
              <img alt="" src="@/assets/img/hotels/d2.jpg"/>
            </div>
            <div class="details">
              <h4 class="d-flex justify-content-between">
                                                        <span>
        ...
        <div class="col-lg-4">
          <div class="single-destinations">
            <div class="thumb">
              <img alt="" src="@/assets/img/hotels/d3.jpg"/>
            </div>
            <div class="details">
              <h4 class="d-flex justify-content-between">
                                                        <span>
        ...
        <div class="col-lg-4">
          <div class="single-destinations">
            <div class="thumb">
              <img alt="" src="@/assets/img/hotels/d4.jpg"/>
            </div>
            <div class="details">
              <h4 class="d-flex justify-content-between">
                                                        <span>
        ...
        <div class="col-lg-4">
          <div class="single-destinations">
            <div class="thumb">
              <img alt="" src="@/assets/img/hotels/d5.jpg"/>
            </div>
            <div class="details">
              <h4 class="d-flex justify-content-between">
                                                        <span>
        ...
        <div class="col-lg-4">
          <div class="single-destinations">
            <div class="thumb">
              <img alt="" src="@/assets/img/hotels/d6.jpg"/>
            </div>
            <div class="details">
              <h4 class="d-flex justify-content-between">
                                                        <span>
    ...
    <div class="container-fluid">
      <div class="row align-items-center justify-content-end">
        ...
        <div class="col-lg-6 col-md-12 home-about-right no-padding">
          <img alt="" class="img-fluid" src="@/assets/img/hotels/about-img.jpg"/>
        </div>
      </div>
    </div>
  </section>
